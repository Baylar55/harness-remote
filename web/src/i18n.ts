...
const translations: Record<LanguageCode, Partial<Record<TranslationKey, string>>> = {
  ...
  it: {
    ...
    'sf.scanMachineQR': 'Scansiona il QR della macchina',
    'sf.scanAnotherMachine': 'Scansiona un’altra macchina',
    'sf.openingScanner': 'Apertura scanner…',
    'sf.addManually': 'Aggiungi manualmente',
  ...
  'zh-TW': {
    ...
    'help.commands': '命令',
    'menubar.file': '檔案',
    'menubar.session': '工作階段',
    'menubar.view': '檢視',
    'menubar.help': '說明',
    'command.newSession': '新增工作階段',
    'command.refreshSessions': '重新整理工作階段',
    'command.addServer': '連線伺服器',
    'command.openSettings': '開啟設定',
    'command.focusComposer': '聚焦提示輸入框',
    'command.stopAgent': '停止代理',
    'command.commandPalette': '命令',
    'command.searchSessions': '搜尋工作階段',
    'command.toggleInspector': '切換檢查器',
    'command.openHelp': '開啟說明',
    'command.groupSession': '工作階段',
    'command.groupServer': '伺服器',
    'command.groupView': '檢視',
    'command.groupOpenSession': '開啟工作階段',
    'command.switchTo': '切換到 {name}',
    'command.manageServers': '管理伺服器',
    'command.palettePlaceholder': '搜尋命令與工作階段…',
    'command.paletteEmpty': '沒有相符的命令',
    'command.navigate': '導覽',
    'command.run': '執行',
    'command.close': '關閉',
    'connect.title': '連線伺服器',
    'connect.subtitle': '選擇 harness、輸入位址，然後驗證連線。',
    'connect.step.harness': 'Harness',
    'connect.step.address': '位址',
    'connect.step.credentials': '認證資訊',
    'connect.harness.opencode': '直接連線到 OpenCode 伺服器。',
    'connect.harness.omp': '透過內附的 Oh My Pi bridge 連線。',
    'connect.harness.pi': '透過 ACP bridge 連線到 PI。',
    'connect.harness.claude': '透過 ACP bridge 連線到 Claude Code。',
    'connect.harness.codex': '透過 ACP bridge 連線到 Codex CLI。',
    'connect.addressHint': '使用執行 harness 的電腦之區域網路位址。',
    'connect.runOnHost': '在主機上執行',
    'connect.copyCommand': '複製命令',
    'connect.copied': '已複製',
    'connect.credentialsHint': '這些認證資訊必須與主機上執行的命令一致。',
    'connect.back': '返回',
    'connect.save': '儲存並連線',
    'connect.next': '繼續',
    'sessions.recentProjects': '最近的專案',
    'sessions.browseFolders': '瀏覽資料夾',
    'sessions.typePathLabel': '開啟路徑',
    ...
    'sf.addMachine': '新增機器',
    'sf.scanMachineQR': '掃描機器 QR 碼',
    'sf.scanAnotherMachine': '掃描另一台機器',
    'sf.openingScanner': '正在開啟掃描器…',
    'sf.addManually': '手動新增',
  ...
  'zh-CN': {
    ...
    'detail.attachImage': '附加图片',
    'detail.removeAttachment': '移除附件',
    'detail.attachedImage': '已附加图片',
    ...
    'sf.addMachine': '添加机器',
    'sf.scanMachineQR': '扫描机器二维码',
    'sf.scanAnotherMachine': '扫描另一台机器',
    'sf.openingScanner': '正在打开扫描器…',
    'sf.addManually': '手动添加',
